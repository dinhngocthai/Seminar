            ...
            <div class="col-md-8">
                <div class="product-content-right">
                    <div class="woocommerce">
                        <!-- <div class="woocommerce-info">Đã có tài khoản? <a class="showlogin" data-toggle="collapse" href="#login-form-wrap" aria-expanded="false" aria-controls="login-form-wrap">Click here to login</a>
                         </div>
...
-->
                        <div class="woocommerce-info">Mã giảm giá? <a class="showcoupon" data-toggle="collapse" href="#coupon-collapse-wrap" aria-expanded="false" aria-controls="coupon-collapse-wrap">Sử dụng</a>
                        </div>
                        ...
                        <form id="coupon-collapse-wrap" method="post" class="checkout_coupon collapse">
                            ...
                            <p class="form-row form-row-last">
                                <input type="submit" value="Gửi" name="apply_coupon" class="button">
                            </p>
...
-->
                                        ...
                                        <p id="billing_address_1_field" class="form-row form-row-wide address-field validate-required">
                                            ...
                                            <input type="text" value="" placeholder="Tên đường" id="billing_address_1" name="billing_address_1" class="input-text ">
                                        </p>

                                        <p id="billing_address_2_field" class="form-row form-row-wide address-field">
                                            <input type="text" value="" placeholder="Quận, huyện,..." id="billing_address_2" name="billing_address_2" class="input-text ">
                                        </p>

                                        <p id="billing_city_field" class="form-row form-row-wide address-field validate-required" data-o_class="form-row form-row-wide address-field validate-required">
                                            <label class="" for="billing_city">Thành phố<abbr title="required" class="required">*</abbr>
                                            </label>
                                            <input type="text" value="" placeholder="Thành phó" id="billing_city" name="billing_city" class="input-text ">
                                        </p>
...
-->
                                        ...
                                        <p id="order_comments_field" class="form-row notes">
                                            ...
                                            <textarea cols="5" rows="2" placeholder="Ghi chú..." id="order_comments" class="input-text " name="order_comments"></textarea>
                                        </p>
                                ...
                                <table class="shop_table">
                                    ...
                                    <tr class="cart_item">
                                        <td class="product-name">
                                            Samsung Galaxy J7 Prime <strong class="product-quantity">× 1</strong> </td>
                                        <td class="product-total">
                                            <span class="amount">3.490.000₫</span> </td>
                                    </tr>
                                    </tbody>
                                    <tfoot>
                                    ...
                                    <tr class="cart-subtotal">
                                        <th>Giỏ Hàng</th>
                                        <td><span class="amount">3.490.000₫</span>
                                        </td>
                                    </tr>
                                ...
                                <div id="payment">
                                    <ul class="payment_methods methods">
                                        ...
                                        <li class="payment_method_paypal">
                                            ...
                                            <label for="payment_method_paypal">PayPal <img alt="PayPal Acceptance Mark" src="https://www.paypalobjects.com/webstatic/mktg/Logo/AM_mc_vs_ms_ae_UK.png"><a title="What is PayPal?" onclick="javascript:window.open('https://www.paypal.com/gb/webapps/mpp/paypal-popup','WIPaypal','toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=yes, width=1060, height=700'); return false;" class="about_paypal" href="https://www.paypal.com/gb/webapps/mpp/paypal-popup">PayPal?</a>
                                            </label>
