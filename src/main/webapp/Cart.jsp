                                ...
                                <ul class="products">
                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="200" height="200" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="img/vendor/product-2.jpg">
                                            <h3>Samsung Galaxy Note 10</h3>
                                            <span class="price"><span class="amount">16.490.000₫</span> <span><del>17.490.000₫</del></span></span>
                                        </a>

                                        <a class="add_to_cart_button" data-quantity="1" data-product_sku="" data-product_id="22" rel="nofollow" href="single-product.html">Chi tiết </a>
                                    </li>

                                    <li class="product">
                                        <a href="single-product.html">
                                            <img width="325" height="325" alt="T_4_front" class="attachment-shop_catalog wp-post-image" src="img/samsung/samsung-galaxy-a31.png">
                                            <h3>Samsung Galaxy A31</h3>
                                            <span class="price"><span class="amount">6.500.000₫</span><span><del>7.50.000₫</del></span> </span>
                                        </a>
