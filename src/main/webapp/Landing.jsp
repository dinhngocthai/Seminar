...
<head>
    ...
    <title class="has_page_title">SM Store</title>
    <!-- FAVICON -->
    <!--
        <link href="//tvp.com.vn/favicons/NEO_LOGO_32.png" rel="icon" type="image/png">
    -->
    <!-- BOOTSTRAP -->
    ...
    <!--  PLUGINS -->
    <link type="text/css" href="//tvp.com.vn/assets/plugins/perfect-scrollbar/css/perfect-scrollbar.min.css" rel="stylesheet">
    <style>
        .text-cover-title {
                    ...
                    <div class="row py-3 text-center justify-content-center">
                        <div class="col-12 col-md-10">
                            <div class="text-cover-wrapper">
                                <h3 class="text-cover-title c-white" style="margin-left: 0% !important;">SM Store</h3>
                                <!--
                                                                <h4 class="text-cover-subtitle c-white strong-400 mt-4">Store</h4>
                                -->
                                ...
                                <div class="text-center mt-5">
                                    <a href="AdminLogin" class="btn btn-styled btn-base-5 btn-outline btn-circle">Đi đến trang admin</a>
                                    <!--/Landing.html/tvp.com.vn/admin-->
                                </div>
                            </div>
                        </div>
                    </div>
...
<script src="//tvp.com.vn/assets/plugins/imagesloaded/imagesloaded.pkgd.min.js"></script>

<!-- APP JS -->
<script src="//tvp.com.vn/assets/js/app.js"></script>
<script src="//tvp.com.vn/assets/js/sm_error_pages_400.js"></script>
</body>
</html>
